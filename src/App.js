...
class App extends React.Component {
  ...
  render() {
    return (
      <>
        <button className="btn btn-outline-primary" onClick={() => { this.setState({ activeTab: "personnages" }) }}>
          Personnages
        </button>
        <button className="btn btn-outline-primary" onClick={() => { this.setState({ activeTab: "continents" }) }}>
          Continents
        </button>
